...
save("./result/A_gau_wf_trun_vs_notrun/cout_trun_vs_notrun.jld2",
    "cout_fisher_notrun_list", cout_fisher_notrun_list,
    "cout_fisher_trun_list", cout_fisher_trun_list)

nrmse_fisher_notrun_list = load("./result/A_gau_wf_trun_vs_notrun/nrmse_trun_vs_notrun.jld2")["nrmse_fisher_notrun_list"]
nrmse_fisher_trun_list = load("./result/A_gau_wf_trun_vs_notrun/nrmse_trun_vs_notrun.jld2")["nrmse_fisher_trun_list"]
# idxrange = 50:50:1000
