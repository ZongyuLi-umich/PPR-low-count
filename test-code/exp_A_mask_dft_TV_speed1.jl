...
A_list = Vector{Any}(undef, r_time)
y_pos_list = Vector{Any}(undef, r_time)
b_list = Vector{Any}(undef, r_time)
x0_spectral_list = Vector{Any}(undef, r_time)
...
for r = 1:r_time
    ...
    global A_list[r] = A
    global y_pos_list[r] = y_pos
    global b_list[r] = b
    global x0_spectral_list[r] = x0_spectral
...
save("../result/A_mask_dft_TV/optimal_init_exp_10times_all_2D_count="*string(avg_count)*".jld2",
