...
for M in M_list
        ...
        xout_lsmm = Array{Array{Any, 1}, 1}(undef, r_time)
        cout_lsmm = Array{Array{Any, 1}, 1}(undef, r_time)
        xout_admm = Array{Array{Any, 1}, 1}(undef, r_time)
        cout_admm = Array{Array{Any, 1}, 1}(undef, r_time)
        xout_lsmm_l1 = Array{Array{Any, 1}, 1}(undef, r_time)
        cout_lsmm_l1 = Array{Array{Any, 1}, 1}(undef, r_time)
        ...
        for r = 1:r_time
                ...
                xout_lsmm_l1[r], cout_lsmm_l1[r] = LSMM_L1_diff(A,y_pos,b;
                        curvhow = :imp, xhow = xhow, reg1 = 32, reg2 = 32,
...
# mean_cout_admm_l1 = mean(cout_admm_l1)
        ...
        save("./A_gau_bne0/A_Gaussian_"*string(xhow)*"_M="*string(M)*".jld",
                ...
                "xout_admm", xout_admm,
                "cout_admm", cout_admm,
                "xout_lsmm_l1", xout_lsmm_l1,
                "cout_lsmm_l1", cout_lsmm_l1,
