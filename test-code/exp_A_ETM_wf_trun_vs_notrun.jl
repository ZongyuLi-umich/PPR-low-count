...
save("./result/A_ETM_wf_trun_vs_notrun/cout_trun_vs_notrun.jld2",
    "cout_fisher_notrun_list", cout_fisher_notrun_list,
    "cout_fisher_trun_list", cout_fisher_trun_list)

nrmse_fisher_notrun_list = load("./result/A_ETM_wf_trun_vs_notrun/nrmse_trun_vs_notrun.jld2")["nrmse_fisher_notrun_list"]
nrmse_fisher_trun_list = load("./result/A_ETM_wf_trun_vs_notrun/nrmse_trun_vs_notrun.jld2")["nrmse_fisher_trun_list"]
# idxrange = 50:50:1000
# plot(idxrange, nrmse_fisher_trun_list, label = "Truncated WF", xlabel = L"a^h",
#         ylabel = "NRMSE", color = :blue, legendfontsize = 16, xguidefontsize=16, yguidefontsize=15)
# # plot!(idxrange, nrmse_fisher_notrun_list, label = "Non-truncated WF", color = :red, linestyle =:dash)
# # xlabel!(L"a^h")
# # ylabel!("NRMSE")
# savefig("./result/A_gau_wf_trun_vs_notrun/trun_vs_notrun_20220310.pdf")
