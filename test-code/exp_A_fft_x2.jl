...
xhow = :real
xtrue = load("./A_fft_shepplogan/test_data_fft.jld")["x2"]
N = size(xtrue, 1)
avg_count = 1
num_mask = 20
niter = 200
...
# save("./A_fft_shepplogan/A_FFT_x2_ODWT_"*string(xhow)*"_mask="*string(num_mask)*".jld",
...
save("./A_fft_shepplogan/A_FFT_x2_spectral_"*string(xhow)*"_mask="*string(num_mask)*".jld",
